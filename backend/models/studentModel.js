...
const studentSchema = new mongoose.Schema({
    ...
    secondarySchoolPassingYear: { type: String },
    secondarySchoolPassingGrade: { type: String },
    secondarySchoolPassingPercent: { type: String },
    higherSchoolPassingYear: { type: String },
    ugPassingYear: { type: String },
    ugPassingGrade: { type: String },
    ugPassingPercent: { type: String },
    pgPassingYear: { type: String },
    pgPassingGrade: { type: String },
    pgPassingPercent: { type: String },
    higherSchoolPassingDivision: { type: String },
    higherSchoolPassingPercent: { type: String },    
