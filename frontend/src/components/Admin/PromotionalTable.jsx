...
import { useGetAllBannerMutation,useDeleteBannerMutation, useGetAllPromotionalMutation, useDeletePromotionalMutation } from '../../slices/adminApiSlice';
      ...
      {numSelected > 0 ? (
        ...
        <Tooltip title="Create Banner">
          <IconButton size="sm" variant="outlined" color="neutral">
            ...
            <CreatePromotionalPop open={open} handleClose={handleClose} />
          </IconButton>
        </Tooltip>
      )}
...
function PromotionalTable() {
    ...
    const banner = promotional
    const [GetAllPromotional, { isSuccess }] = useGetAllPromotionalMutation();
    const [DeletePromotional,DeleteState] = useDeletePromotionalMutation(); // Hook for deleting banner
    ...
    const deleteSelectedBanners = async () => {
      try {
        ...
        dispatch(DeletePromotionalState(res))
        setSelected([]);
      } catch (error) {
