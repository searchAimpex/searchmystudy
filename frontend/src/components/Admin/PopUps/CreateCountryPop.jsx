...
const onSubmit = async () => {
  try {
    ...
    // RTK Query unwrap() throws the error response directly
    if (error?.data?.message) {
      console.error("API Error:", error.data.message); // ✅ log in console
      toast.error(error.data.message); // or show in UI
    } else {
