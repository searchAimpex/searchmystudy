...
function MbbsUpdateCountryPop({ open, handleClose, countryData }) {
...
console.log(countryData,"ssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
  ...
  return (
    <Dialog fullWidth={true} open={open} onClose={handleClose}>
      <DialogTitle className="text-white bg-custom-primary font-bold">Update MBBS Country</DialogTitle>
      <DialogContent>
        <div className="py-2">
          ...
          >
            Add Section
                    ...
                    <FormControlLabel
                        control={
                            <Checkbox
                                checked={formValues.ECFMG}  // Will be true or false
                                onChange={(e) => {
                                    setFormValues((prev) => ({
                                        ...prev,
...
<FormControlLabel
                        control={
                            <Checkbox
                                checked={formValues.MCI}  // Will be true or false
                                onChange={(e) => {
                                    setFormValues((prev) => ({
                                        ...prev,
...
export default MbbsUpdateCountryPop;