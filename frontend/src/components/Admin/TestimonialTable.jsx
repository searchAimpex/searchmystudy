...
import { useTestimonialFetchAllMutation, useServiceDeleteMutation, useTestimonialDeleteMutation } from '../../slices/adminApiSlice';
...
function EnhancedTableToolbar({ numSelected, selectedRow, onViewBanner, onDelete }) {
    ...
    return (
        ...
        >
            ...
            <CreateTestimonialPop open={open} handleClose={handleClose} />
...
function TestimonialTable() {
    ...
    const services = testimonial || []; // Assuming `testimonial` state holds the array of testimonials
    const [TestimonialFetchAll, { isSuccess }] = useTestimonialFetchAllMutation();
    const [TestimonialDelete, DeleteState] = useTestimonialDeleteMutation();
