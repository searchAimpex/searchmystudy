...
import { useTestimonialFetchAllMutation, useServiceDeleteMutation, useTestimonialDeleteMutation, useCreateCounsellorMutation, useAllCounsellorMutation, useCounsellorDeleteMutation } from '../../slices/adminApiSlice';
...
function EnhancedTableToolbar({ numSelected, selectedRow, onViewBanner, onDelete }) {
    ...
    return (
        ...
        >
            ...
            <CreateCounsellorPop open={open} handleClose={handleClose} />
...
function CounsellorTable() {
    ...
    const services = counsellors || []; // Assuming `testimonial` state holds the array of testimonials
    const [AllCounsellor, { isSuccess }] = useAllCounsellorMutation();
    const [CounsellorDelete, DeleteState] = useCounsellorDeleteMutation();
