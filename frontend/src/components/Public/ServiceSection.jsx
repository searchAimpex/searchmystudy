  ...
  return (
    <div className='mx-[50px] py-2'>
      <div className='flex flex-col justify-center items-center'>
        ...
        >
          <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-main">Services</span>
          <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-gold-main">We</span>
          <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-main">Provided</span>
        </motion.div>
