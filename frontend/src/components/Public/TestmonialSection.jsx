    ...
    <div className=''>
      <div className='flex flex-col justify-center items-center'>
        ...
        >
          ...
          <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-main text-gold-main">
            Our
          </span>
          <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-main text-blue-main">
            Studeny
          </span>
          <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-main text-gold-main">
            Say
