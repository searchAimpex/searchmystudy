            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base">
                  Plot no 34, Dwarka Mor Metro Station, Uttam Nagar,<br />
                  Delhi, Pincode – 110059
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex space-x-4 mt-2">
                  <a href="https://facebook.com" className="hover:text-gray-300"><FacebookIcon /></a>
                  <a href="https://twitter.com" className="hover:text-gray-300"><TwitterIcon /></a>
                  <a href="https://instagram.com" className="hover:text-gray-300"><InstagramIcon /></a>
                  <a href="https://linkedin.com" className="hover:text-gray-300"><LinkedInIcon /></a>
                </div>
              </div>
            </div>
          </div>
