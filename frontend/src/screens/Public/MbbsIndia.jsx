...
import poster from "../../assets/Red_and_Yellow_Abstract_Study_Abroad_Facebook Post.JPG"
  ...
  return (
    <div className=" mx-auto ">
      ...
      <section className="relative flex flex-col md:flex-row items-center h-[200px] bg-blue-200 overflow-hidden">
        ...
        >
          <motion.h1
            className="text-4xl sm:text-4xl md:text-5xl font-bold pl-2 text-gray-800"
